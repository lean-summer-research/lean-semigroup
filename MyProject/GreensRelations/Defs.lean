...
/-helper lemmas-/
lemma H_equiv_iff_exists {x e : S} (idem: IsIdempotentElem (e)) (h : x 𝓗 e) :
...
lemma idempotent_left_identity {e : S} (he : IsIdempotentElem e) (ha : a 𝓗 e) :
  e * a = a := by
...
lemma idempotent_right_identity {e : S} (he : IsIdempotentElem e) (ha : a 𝓗 e) :
  a * e = a := by
...
lemma idempotent_identity_H_eqv {e : S} (he : IsIdempotentElem e) (ha : a 𝓗 e) :
    e * a = a ∧ a * e = a :=
...
lemma H_mul_closed {e : S} (he : IsIdempotentElem e)
    (ha : a 𝓗 e) (hb : b 𝓗 e) :
    a * b 𝓗 e := by
